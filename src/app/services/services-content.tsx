        ...
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center text-center hover:shadow-lg transition-shadow">
              <img width="600" height="160" src="/images/home-care.webp" alt="Home Care" className="rounded mb-4 h-40 object-cover w-full" />
            ...
            {/* Service Card 2 */}
            <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center text-center hover:shadow-lg transition-shadow">
              <img width="600" height="160" src="/images/live-in-care.webp" alt="Live-in Care" className="rounded mb-4 h-40 object-cover w-full" />
            ...
            {/* Service Card 3 */}
            <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center text-center hover:shadow-lg transition-shadow">
              <img width="600" height="160" src="/images/respite-care.webp" alt="Respite Care" className="rounded mb-4 h-40 object-cover w-full" />
