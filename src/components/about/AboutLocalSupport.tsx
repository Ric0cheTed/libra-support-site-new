...
import type { AboutLocalSection } from "@/types/about";

type AboutLocalSupportProps = {
  section: AboutLocalSection;
};

export function AboutLocalSupport({ section }: AboutLocalSupportProps) {
  return (
    <section className="bg-white py-16 sm:py-20">
      <Container>
        <div className="grid gap-8 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:gap-12">
          ...
          <div className="rounded-[2rem] border border-stone-200/80 bg-[linear-gradient(180deg,rgba(247,244,239,0.9),rgba(255,255,255,0.98))] p-6 shadow-[0_28px_70px_-48px_rgba(15,23,42,0.28)] sm:p-8">
